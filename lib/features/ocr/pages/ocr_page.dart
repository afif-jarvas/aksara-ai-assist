...
class _OCRPageState extends ConsumerState<OCRPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          title: Text(tr(ref, 'ocr_title'),
              style:
                  GoogleFonts.oswald(color: Colors.black, letterSpacing: 1.5)),
